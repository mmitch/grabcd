#!/usr/bin/perl -w
# $Id: scancd.pl,v 1.10 2004-06-08 19:57:11 mitch Exp $
#
...
my $term = new Term::ReadLine 'scancd $Id: scancd.pl,v 1.10 2004-06-08 19:57:11 mitch Exp $';
$|++;
...
$path =~ s,/,___,;
$path =~ s/ /\\ /g;
system('echo', 'scp', $file, "$remote/$path");
